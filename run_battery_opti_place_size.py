...
options = {"static_emissions": True,  # True: calculation with static emissions,
           ...
           "T_VL": 35,  # choose between 35 and 55 "Vorlauftemperatur"
           "alpha_th": 0.8,  # relative size of heat pump (between 0 and 1)
           "beta_th": 0.3,  # relative size of thermal energy storage (between 0 and 1)
           "k_loss": 0.00672,  # selbstberechneter Wert für k_loss
           "show_grid_plots": False,  # show gridplots before and after optimization

           "filename_results": "results/" + building_type + "_" + \
                               building_age + "TESMPV03.pkl",
           "filename_inputs": "results/inputs_" + building_type + "_" + \
                              building_age + "TESMPV03.pkl",
                            ...
                            if (vm_pu_total[n, d, t] < 0.96):
                                if options["rel1_or_abs0_violation_change"]:
                                    ...
                                    if (powSubtrPrev[n, d, t] < change_value):
                                        constraint_SubtrMax[n, d, t] = 0
                                        print(
                                            "Subtraction already set to 0 for node" + str(n) + " and timestep" + str(t))
                                        print("Raising Injection now!")
                                        constraint_InjMin[n, d, t] += change_value - powSubtrPrev[n, d, t]
                                    else:
                                        constraint_SubtrMax[n, d, t] = powSubtrPrev[n, d, t] - change_value
...
options = {"static_emissions": True,  # True: calculation with static emissions,
           ...
           "T_VL": 35,  # choose between 35 and 55 "Vorlauftemperatur"
           "alpha_th": 0.8,  # relative size of heat pump (between 0 and 1)
           "beta_th": 0.6,  # relative size of thermal energy storage (between 0 and 1)
           "k_loss": 0.00467,  # selbstberechneter Wert für k_loss
           "show_grid_plots": False,  # show gridplots before and after optimization

           "filename_results": "results/" + building_type + "_" + \
                               building_age + "TESMPV06.pkl",
           "filename_inputs": "results/inputs_" + building_type + "_" + \
                              building_age + "TESMPV06.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
...
options = {"static_emissions": True,  # True: calculation with static emissions,
           ...
           "T_VL": 35,  # choose between 35 and 55 "Vorlauftemperatur"
           "alpha_th": 0.8,  # relative size of heat pump (between 0 and 1)
           "beta_th": 0.9,  # relative size of thermal energy storage (between 0 and 1)
           "k_loss": 0.00401,  # selbstberechneter Wert für k_loss
           "show_grid_plots": False,  # show gridplots before and after optimization

           "filename_results": "results/" + building_type + "_" + \
                               building_age + "TESMPV09.pkl",
           "filename_inputs": "results/inputs_" + building_type + "_" + \
                              building_age + "TESMPV09.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
...
options = {"static_emissions": True,  # True: calculation with static emissions,
           ...
           "T_VL": 35,  # choose between 35 and 55 "Vorlauftemperatur"
           "alpha_th": 0.8,  # relative size of heat pump (between 0 and 1)
           "beta_th": 1.2,  # relative size of thermal energy storage (between 0 and 1)
           "k_loss": 0.00368,  # selbstberechneter Wert für k_loss
           "show_grid_plots": False,  # show gridplots before and after optimization

           "filename_results": "results/" + building_type + "_" + \
                               building_age + "TESMPV12.pkl",
           "filename_inputs": "results/inputs_" + building_type + "_" + \
                              building_age + "TESMPV12.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
...
options = {"static_emissions": True,  # True: calculation with static emissions,
           ...
           "T_VL": 35,  # choose between 35 and 55 "Vorlauftemperatur"
           "alpha_th": 0.8,  # relative size of heat pump (between 0 and 1)
           "beta_th": 1.5,  # relative size of thermal energy storage (between 0 and 1)
           "k_loss": 0.00349,  # selbstberechneter Wert für k_loss
           "show_grid_plots": False,  # show gridplots before and after optimization

           "filename_results": "results/" + building_type + "_" + \
                               building_age + "TESMPV15.pkl",
           "filename_inputs": "results/inputs_" + building_type + "_" + \
                              building_age + "TESMPV15.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
