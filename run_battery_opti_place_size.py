...
options =   {"static_emissions": False,  # True: calculation with static emissions,
            ...
            "filename_results": "results/" + building_type + "_" + \
                                                   building_age + "typtage_emissionen_30.pkl",
...
"""print("")
print(outputs)
print("emissions nodes:")
print(emissions_nodes)
print("emissions grid:")
print(emissions_grid)
print("costs nodes:")
print(costs_nodes)
print("costs grid:")
print(costs_grid)"""
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "emissions_typtage25.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
while boolean_loop:
    ...
    if all(solution_found[d] == True for d in days):
        print("Congratulations! Your optimization and loadflow calculation has been successfully finished after " + str(
            iteration_counter) + " iteration steps!")
        break
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_20.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 20 Typtage:")
print(objective_function)
print("duration_program für 20 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_15.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_14.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_13.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_12.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_11.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_10.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 10 Typtage:")
print(objective_function)
print("duration_program für 10 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_09.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 9 Typtage:")
print(objective_function)
print("duration_program für 9 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_08.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 8 Typtage:")
print(objective_function)
print("duration_program für 8 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_07.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 7 Typtage:")
print(objective_function)
print("duration_program für 7 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_06.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 6 Typtage:")
print(objective_function)
print("duration_program für 6 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_05.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 5 Typtage:")
print(objective_function)
print("duration_program für 5 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_04.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 4 Typtage:")
print(objective_function)
print("duration_program für 4 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_03.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 3 Typtage:")
print(objective_function)
print("duration_program für 3 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_02.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 2 Typtage:")
print(objective_function)
print("duration_program für 2 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_01.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 1 Typtage:")
print(objective_function)
print("duration_program für 1 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_26.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 26 Typtage:")
print(objective_function)
print("duration_program für 26 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_27.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 27 Typtage:")
print(objective_function)
print("duration_program für 27 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_28.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 28 Typtage:")
print(objective_function)
print("duration_program für 28 Typtage")
print(duration_program)
print("")
print("")
print("")
...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/" + building_type + "_" + \
                               building_age + "Typtage_emissionen_29.pkl",
           "apc_while_voltage_violation": True,  # True: uses apc, when voltage violations occur
           # False: does not use apc, when voltage violations occur
           "cut_Inj/Subtr_while_voltage_violation": True,  # True: cuts Inj or Subtr, when voltage violations occur
           # depends automatically on the fact, whether voltage is too high or too low
...
print("")
print("")
print("objective value für 29 Typtage:")
print(objective_function)
print("duration_program für 29 Typtage")
print(duration_program)
print("")
print("")
print("")