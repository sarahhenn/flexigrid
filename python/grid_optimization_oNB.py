...
#%% extract node and line information from pandas-network
    ...
    for [n,m] in nodeLines:
        powerLine_max[n,m] = (net.line['max_i_ka'][nodeLines.index((n,m))])*400000000000000
...
#%% optimization model
    ...
    trafo_max = float(net.trafo.sn_mva*1000000000000000)
    ...
    powerLine = model.addVars(nodeLines,days, timesteps, vtype="C", lb=-10000000000000000, name="powerLine_")
