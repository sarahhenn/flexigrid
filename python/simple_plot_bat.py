...
def simple_plot_bat(net, respect_switches=False, line_width=1.0, bus_size=1.0, ext_grid_size=1.0,
                ...
                bus_color="b", bat_color="r", line_color='grey', trafo_color='k', ext_grid_color='y',
    ...
    buses_with_bat = set(net.bat.index * net.bat.ex)
    batc = create_bus_collection(net, buses_with_bat, size=bus_size, color=bat_color, zorder=10)
