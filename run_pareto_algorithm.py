...
options = {"static_emissions": False,  # True: calculation with static emissions,
           ...
           "filename_results": "results/pareto_results/" + building_type + "_" + \
                               building_age + "pareto_CostsMin.pkl",
           "filename_inputs": "results/pareto_results/inputs_" + building_type + "_" + \
                              building_age + "pareto_CostsMin.pkl",
           ...
           "heatpump_seperated_costs": False,  # True: Heatpumps power costs: 18.56 ct/kWh (apart from other power users)
